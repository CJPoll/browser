...
module Repositories
  ...
  #
  # This is a Repository layer component that:
  # - Receives and returns Domain objects (never rows or hashes)
  # - Owns the downloads table schema and every SQL string touching it
  # - Is tested against a real (temporary) SQLite database, never mocked
